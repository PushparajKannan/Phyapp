...
//public class RecyclerHistroyAdapter {


public class RecyclerHistroyAdapter  extends RecyclerView.Adapter<com.phyapp.root.physiotherapy.Adapters.RecyclerHistroyAdapter.ViewHolder> {
    private static final String LOG_TAG = com.phyapp.root.physiotherapy.Adapters.ClasicRecyclerAdapter.class.getSimpleName();
    private ArrayList<PhyHistoryModel.Src> mItems;
    com.phyapp.root.physiotherapy.Adapters.RecyclerHistroyAdapter.ItemListener mListener;
    ...
    public  RecyclerHistroyAdapter(Activity context, ArrayList<PhyHistoryModel.Src> program, com.phyapp.root.physiotherapy.Adapters.RecyclerHistroyAdapter.ItemListener listener) {
    ...
    public void setOnItemClickListener(com.phyapp.root.physiotherapy.Adapters.RecyclerHistroyAdapter.ItemListener listener) {
        mListener = listener;
    }

    @Override
    public com.phyapp.root.physiotherapy.Adapters. RecyclerHistroyAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater
                .from(parent.getContext())
                .inflate(R.layout.history_list_phy, parent, false);
        context = parent.getContext();
        return new com.phyapp.root.physiotherapy.Adapters. RecyclerHistroyAdapter.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(final com.phyapp.root.physiotherapy.Adapters. RecyclerHistroyAdapter.ViewHolder holder, final int position) {
...
*/
   ...
   /* @Override
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public PhyHistoryModel.Src pName;
        TextView patienname,date,address,time,service,subservice,extra;
        View textContainer;
        //TextView Itemone,Itemtwo,Appointment,tilldate;
        Button Appoinment;
        LinearLayout adser;
        ArrayList<PhyHistoryModel.Src.Item> listser=new ArrayList<PhyHistoryModel.Src.Item>();
        ...
        public void setData(PhyHistoryModel.Src pName) {
            this.pName = pName;
            ...
            patienname.setText(pName.getPatientName());
            date.setText(pName.getDate());
            address.setText(pName.getAddress());
            service.setText(pName.getServicecat());
            subservice.setText(pName.getService());
    ...
    public interface ItemListener {
        void onItemClick(PhyHistoryModel.Src pName, int position);
    }
